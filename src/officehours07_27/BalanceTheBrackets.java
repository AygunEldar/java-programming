...
public class BalanceTheBrackets {
    /*
    For compiler one of the most important task  --- balancedBrackets

    * Create a method that will accept a String of brackets. Determine if the brackets are balanced. Brackets are balanced if the closing bracket matches the opening one. https://www.hackerrank.com/challenges/balanced-brackets/problem?h_l=interview&playlist_slugs%5B%5D=interview-preparation-kit&playlist_slugs%5B%5D=stacks-queues
...
Map<Character,Character> m = new HashMap<>();
        ...
        for (int i = 0; i < exp.length() ; i++) {
          ...
          char ch = exp.charAt(i);
            ...
            if( ch == '(' || ch =='[' || ch =='{'){
                ...
                }else if(exp.charAt(i) != m.get(stack.pop())){
    ...
    public static boolean isBalanced_Saim(String str){
        String open ="{[(";
        Stack<Character> stack = new Stack();
